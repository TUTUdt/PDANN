...
#         url1 = r'http://data-cbr.csiro.au/thredds/ncss/catch_all/CMAR_CAWCR-Wave_archive/CAWCR_Wave_Hindcast_1979-2010/gridded/ww3.aus_4m.'\
...
#
#         url2 = r'https://data-cbr.csiro.au/thredds/ncss/catch_all/CMAR_CAWCR-Wave_archive/CAWCR_Wave_Hindcast_1979-2010/gridded/ww3.glob_24m.'\
#                + str(year) + str(month).zfill(2) + \
#                r'.nc?var=U10&var=V10&var=dir&var=hs&var=t02&var=tm0m1&north=0&west=135&east=170&south=-50&disableProjSubset=on&horizStride=1&&time_start='\
#                + str(year) + '-' + str(month).zfill(2) + r'-01T00%3A00%3A00Z&time_end=' + str(year) + '-' + str(month).zfill(2) + '-' + str(monthday[month]) + \
#                r'T23%3A00%3A00Z&timeStride=1&accept=netcdf'
#         print(url2)
